        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="AiWriter" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="buttons">
                    <button type="button" class="button bravo_test_db">
                        {{__("Test DB")}}
                    </button>
...
@section('scripts')
    ...
    <script src="{{asset('installer/js/jquery-3.6.3.min.js')}}"></script>
