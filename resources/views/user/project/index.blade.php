...
<div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
    <div class="">
        <div class="row align-items-center">
          <div class="col-6">
            <h4 class="mb-0">{{ __('common.my_documents') }}</h4>
          </div>
          <!--<div class="col-6">-->
          <!--  <button class="btn btn-sm btn-dark btn-pointer rounded-btn float-end" data-bs-toggle="modal" data-bs-target="#templateModal">-->
          <!--      {{ __('common.create_document') }}-->
          <!--  </button>-->
          <!--</div>-->
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-btn shadow-none bg-grey-light border-0 search-box" data-url={{ url('projects/search') }} placeholder="{{ __('common.search_projects_by_name') }}">
                </div>
            </div>
            <!--
