...
<div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
    <div class="">
        <div class="row align-items-center">
          <div class="col-6">
            <h4 class="mb-0">{{ __('common.ai_images') }}</h4>
          </div>
          <div class="col-6">
            <button class="btn btn-sm btn-dark btn-pointer rounded-btn float-end" data-bs-toggle="modal" data-bs-target="#createImageModal">
                {{ __('common.generate_ai_image') }}
            </button>
          </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-btn shadow-none bg-grey-light border-0 search-box" data-url={{ url('images/search') }} placeholder="{{ __('common.search_images_by_name') }}">
                </div>
            </div>
            <!--
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header border-bottom pb-2">
                    <div>
                        <h5 class="modal-title">{{ __('You don\'t have an active subscription plan.') }}</h5>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('common.generate_ai_image') }}</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
