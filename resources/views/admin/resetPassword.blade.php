                    ...
                    <div class="card card-shadow card-login">
                        <div class="row">
                            <div class="col-md-5 d-md-flex justify-content-center flex-column bg-soft-primary p-8 p-md-5 bg-pattern">
                                ...
                                <small class="mb-4">{{ __('Enter your new password.') }}</small>
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
                                    <form class="js-validate needs-validation" novalidate="">
                                        @csrf
                                        <div class="mb-4">
                                            <label class="form-label" for="resetPasswordSrEmail" tabindex="0">{{ __('Password') }}</label>
                                            <input type="password" class="form-control form-control-lg" name="password" tabindex="1" required="">
                                            <span class="invalid-feedback">{{ __('Please enter a valid password.') }}</span>
                                        </div>
                                        <div>
                                            <label class="form-label" for="resetPasswordSrEmail" tabindex="0">{{ __('Confirm Password') }}</label>
                                            <input type="password" class="form-control form-control-lg" name="password_confirmation" tabindex="1" required="">
                                            <span class="invalid-feedback">{{ __('Please enter a valid confirmation password.') }}</span>
                                        </div>
                                        @if (Helper::config('recaptcha_active') == 1)
                                        ...
                                        <div class="d-grid gap-4 mt-4">
                                            <button type="submit" class="btn btn-dark btn-lg">{{ __('Reset password') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
